...
test('homepage uses the SimpleAcademicHomepage shell with Haotian Xie content', () => {
  ...
  assert.match(zhAbout, /师从<a href="https:\/\/research\.polyu\.edu\.hk\/en\/persons\/yung-po-tsang\/"[^>]*>曾榕波博士<\/a>/);
  assert.match(zhAbout, /师从<a href="https:\/\/www\.dase\.hku\.hk\/people\/j-y-li"[^>]*>李加阳教授<\/a>/);
  assert.match(zhAbout, /金融学.*经济学学士学位/);
  assert.match(zhAbout, /<a href="https:\/\/bibs\.bnu\.edu\.cn\/en\/index\.htm"[^>]*>金融学<\/a>/);
  ...
  assert.match(zhAbout, /师从<a href="https:\/\/sss\.bnu\.edu\.cn\/en\/Faculty\/Professor\/1fb42055bc1e42ca8e13c27e378e2d82\.htm"[^>]*>狄增如教授<\/a>/);
  ...
  assert.match(zhMisc, /工业工程与物流管理工学硕士/);
  assert.doesNotMatch(zhMisc, /DASE/);
  assert.match(zhMisc, /金融学经济学学士/);
