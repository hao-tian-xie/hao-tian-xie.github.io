...
test('homepage uses the SimpleAcademicHomepage shell with Haotian Xie content', () => {
  ...
  assert.match(about, /Starting Spring 2027, I will join the Department of Industrial and Systems Engineering \(ISE\) at The Hong Kong Polytechnic University as a Ph\.D\. student\./);
